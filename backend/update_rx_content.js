/**
 * Run with: node update_rx_content.js
 * Updates the Utopic RX Face Recognition product with rich content sections.
 */
...
const announcementBar = {
  en: "Utopic RX Smart Lock + Face Reader — Hands-free door access with face recognition. World-exclusive patented key override technology.",
  ar: "قفل Utopic RX الذكي + قارئ الوجه — وصول بدون لمس عبر تقنية التعرّف على الوجه. تقنية تجاوز المفتاح المسجّلة حصرياً.",
};
...
const contentSections = [
  ...
  },
  {
    ...
    heading: {
      en: "Open with Face Recognition or Password",
      ar: "افتح بالتعرّف على الوجه أو كلمة المرور",
    },
    text: {
      en: "Lock or unlock your door by scanning your face or entering your PIN code. The face reader recognises you instantly — no touch required.",
      ar: "افتح بابك بمسح وجهك أو إدخال رقمك السري. يتعرّف قارئ الوجه عليك فوراً دون لمس.",
    },
    image: "https://endesi.tsoftstatic.com/Data/EditorFiles/facer2.png",
  },
  {
    type: "text-image",
...
const specGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        en: "Smart Bridge for remote internet access",
        ar: "جسر ذكي للوصول عن بُعد عبر الإنترنت",
      },
      {
...
const boxContents = [
  ...
  { icon: "📷", name: { en: "Face Reader Module", ar: "وحدة قارئ الوجه" } },
...
async function run() {
  ...
  if (result) {
    ...
    console.log("❌ Product not found: desi-utopic-rx-face-recognition");
  }
