...
const About = () => {
  ...
  return (
    <>
      ...
      />
      <main>
        <div className="max-w-3xl mx-auto px-4 md:px-6 py-8 md:py-12 lg:py-16">
          {/* Header */}
          <div className="text-center mb-6 md:mb-10">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-600 mb-1 md:mb-2">
          ...
          {/* Lead paragraph — bold */}
          <p className="font-bold text-neutral-900 leading-relaxed mb-3 md:mb-4 text-sm md:text-base">
            {t({
          ...
          <p className="text-neutral-600 leading-relaxed mb-3 md:mb-4 text-sm md:text-base">
            {t({
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 md:mb-10 text-sm md:text-base">
            {t({
          ...
          <div className="flex items-center justify-center mb-6 md:mb-10">
            ...
            <span className="mx-3 md:mx-4 text-neutral-300 text-base md:text-lg">
              —
            </span>
            <div className="flex-1 border-t border-neutral-200" />
          </div>
          ...
          {/* Market Leader */}
          <h2 className="text-xl md:text-2xl font-bold text-neutral-900 mb-2 md:mb-3">
          ...
          <p className="text-neutral-600 leading-relaxed mb-4 md:mb-4 text-sm md:text-base">
            {t({
          ...
          <p className="text-neutral-600 leading-relaxed italic mt-6 md:mt-10 text-sm md:text-base">
            {t({
